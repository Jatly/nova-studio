...
const Hero = () => {
  return (
    <section id="hero" className="relative overflow-hidden bg-zinc-950 pt-24">
      {/* Background Effects */}{" "}
      <div className="absolute inset-0 overflow-hidden">
        {" "}
        <div className="absolute left-1/2 top-0 h-[700px] w-[700px] -translate-x-1/2 rounded-full bg-purple-600/20 blur-3xl" />{" "}
        <div className="absolute left-0 bottom-0 h-[500px] w-[500px] rounded-full bg-fuchsia-500/10 blur-3xl" />{" "}
        ...
        <div className="grid items-center gap-10 py-20 lg:grid-cols-2">
          ...
          >
            ...
            <p className="mt-8 max-w-lg text-lg leading-relaxed text-zinc-400">
              We partner with ambitious startups and modern brands to design,
              build, and scale digital products that drive growth, engage users,
