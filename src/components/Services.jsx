...
return ( <section
 ...
 >
{/* Background Glow */} <div className="absolute inset-0 pointer-events-none"> <div className="absolute left-0 top-20 h-72 w-72 rounded-full bg-purple-500/10 blur-3xl" /> <div className="absolute right-0 bottom-0 h-72 w-72 rounded-full bg-indigo-500/10 blur-3xl" /> </div>
  ...
  <div className="relative mx-auto max-w-7xl px-6 lg:px-10">
    ...
    >
      ...
      <p className="mt-6 text-lg leading-relaxed text-zinc-400">
        ...
        exceptional digital experiences that help brands grow,
        engage customers, and stand out in competitive markets.
      </p>
    </motion.div>
      ...
      <div className="relative flex flex-col items-center justify-between gap-8 text-center lg:flex-row lg:text-left">
        <div>
          ...
          <p className="mt-3 max-w-xl text-zinc-400">
            Partner with us to transform ideas into impactful
            digital experiences that delight users and drive
            business growth.
          </p>
        </div>
